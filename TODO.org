...
**** TODO Add a render object that tracks the current scanline
**** TODO Add a sync method (or similar) to render that can trigger NMI
**** TODO Add a toplevel STEP-FRAME driver in clones.lisp
*** Implement Nametable rendering
**** TODO Add a framebuffer to the renderer
