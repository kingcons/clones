...
**** WAIT Maybe get Klaus' 6502 perfect tests running on NES?
*** Implement PPU
**** DONE Scaffold PPU module
**** Get PPU Registers working
***** DONE Find docs + Write tests
***** TODO Finish bulk of PPU register behavior (ppu read buffer)
...
**** Get PPU Timing correct
***** TODO Start on PPU Timing
*** TODO Consider rewriting structs to be classes, all about whether performance is tolerable
**** No need for methods or GFs since there is no dispatch, just use functions and slots and slot-value
*** Docs and Tests
