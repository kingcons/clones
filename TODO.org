...
**** TODO Rewrite all stack interactions. Stack is 0x100 -> 0x1FF but I was treating it as zero page.
**** TODO Factor out FETCH-WORD from absolute addressing and STACK-POP-ADDRESS. Rename stack ops.
...
**** TODO Need an update strategy for read-modify-write commands. :-(
