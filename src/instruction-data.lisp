...
(defvar *instructions*
  '((adc ((#x61 2 6 indirect-x)
    ...
    (dec ((#xc6 2 5 zero-page t)
          (#xce 3 6 absolute t)
          (#xd6 2 7 zero-page-x t)
          (#xde 3 7 absolute-x t))
     "Decrement Memory")
    ...
    (inc ((#xe6 2 5 zero-page t)
          (#xee 3 6 absolute t)
          (#xf6 2 6 zero-page-x t))
     "Increment Memory")
    ...
    (sbc ((#xe1 2 6 indirect-x)
          ...
          (#xfd 3 4 absolute-x))
     "Subtract with Carry")
    (sta ((#x81 2 6 indirect-x t)
          (#x85 2 3 zero-page t)
          (#x8d 3 4 absolute t)
          (#x91 2 6 indirect-y t)
          (#x95 2 4 zero-page-x t)
    ...
    (stx ((#x86 2 3 zero-page t)
     ...
     "Store X Register")
    (sty ((#x84 2 3 zero-page t)
          (#x8c 3 4 absolute t)
          (#x94 2 4 zero-page-x t))
     "Store Y Register")
    (bcc ((#x90 2 2 relative t))
     "Branch on Carry Clear" t)
    (bcs ((#xb0 2 2 relative t))
     "Branch on Carry Set" t)
    (beq ((#xf0 2 2 relative t))
     "Branch on Equal" t)
    (bmi ((#x30 2 2 relative t))
     "Branch on Minus (negative)" t)
    (bne ((#xd0 2 2 relative t))
     "Branch on Not Equal" t)
    (bpl ((#x10 2 2 relative t))
     "Branch on Plus (positive)" t)
    (bvc ((#x50 2 2 relative t))
     "Branch on Overflow Clear" t)
    (bvs ((#x70 2 2 relative t))
