...
(defvar *instructions*
  '((adc ((#x61 2 6 indirect-x)
          ...
          (#x79 3 4 absolute-y)
          (#x7d 3 4 absolute-x))
     "Add with Carry" :access-pattern :read)
    (and ((#x21 2 6 indirect-x)
          ...
          (#x39 3 4 absolute-y)
          (#x3d 3 4 absolute-x))
     "And with Accumulator" :access-pattern :read)
    (asl ((#x06 2 5 zero-page)
          (#x0a 1 2 accumulator)
          (#x0e 3 6 absolute)
          (#x16 2 6 zero-page-x)
          (#x1e 3 7 absolute-x))
     "Arithmetic Shift Left" :access-pattern :read-modify-write)
    (bit ((#x24 2 3 zero-page)
          (#x2c 3 4 absolute))
     "Test Bits with Accumulator" :access-pattern :read)
    (cmp ((#xc1 2 6 indirect-x)
          ...
          (#xd9 3 4 absolute-y)
          (#xdd 3 4 absolute-x))
     "Compare with Accumulator" :access-pattern :read)
    (cpx ((#xe0 2 2 immediate)
          (#xe4 2 3 zero-page)
          (#xec 3 4 absolute))
     "Compare with X Register" :access-pattern :read)
    (cpy ((#xc0 2 2 immediate)
          (#xc4 2 3 zero-page)
          (#xcc 3 4 absolute))
     "Compare with Y Register" :access-pattern :read)
    (dec ((#xc6 2 5 zero-page)
          (#xce 3 6 absolute)
          (#xd6 2 6 zero-page-x)
          (#xde 3 7 absolute-x))
     "Decrement Memory" :access-pattern :read-modify-write)
    (eor ((#x41 2 6 indirect-x)
          ...
          (#x59 3 4 absolute-y)
          (#x5d 3 4 absolute-x))
     "Exclusive OR with Accumulator" :access-pattern :read)
    (inc ((#xe6 2 5 zero-page)
          (#xee 3 6 absolute)
          (#xf6 2 6 zero-page-x)
          (#xfe 3 7 absolute-x))
     "Increment Memory" :access-pattern :read-modify-write)
    (lda ((#xa1 2 6 indirect-x)
          ...
          (#xb9 3 4 absolute-y)
          (#xbd 3 4 absolute-x))
     "Load into Accumulator" :access-pattern :read)
    (ldx ((#xa2 2 2 immediate)
          (#xa6 2 3 zero-page)
          (#xae 3 4 absolute)
          (#xb6 2 4 zero-page-y)
          (#xbe 3 4 absolute-y))
     "Load into X Register" :access-pattern :read)
    (ldy ((#xa0 2 2 immediate)
          (#xa4 2 3 zero-page)
          (#xac 3 4 absolute)
          (#xbc 3 4 absolute-x)
          (#xb4 2 4 zero-page-x))
     "Load into Y Register" :access-pattern :read)
    (lsr ((#x46 2 5 zero-page)
          (#x4a 1 2 accumulator)
          (#x4e 3 6 absolute)
          (#x56 2 6 zero-page-x)
          (#x5e 3 7 absolute-x))
     "Logical Shift Right" :access-pattern :read-modify-write)
    (ora ((#x01 2 6 indirect-x)
          ...
          (#x19 3 4 absolute-y)
          (#x1d 3 4 absolute-x))
     "Inclusive OR with Accumulator" :access-pattern :read)
    (rol ((#x2a 1 2 accumulator)
          (#x26 2 5 zero-page)
          (#x2e 3 6 absolute)
          (#x36 2 6 zero-page-x)
          (#x3e 3 7 absolute-x))
     "Rotate Left" :access-pattern :read-modify-write)
    (ror ((#x66 2 5 zero-page)
          (#x6a 1 2 accumulator)
          (#x6e 3 6 absolute)
          (#x76 2 6 zero-page-x)
          (#x7e 3 7 absolute-x))
     "Rotate Right" :access-pattern :read-modify-write)
    (sbc ((#xe1 2 6 indirect-x)
          ...
          (#xf9 3 4 absolute-y)
          (#xfd 3 4 absolute-x))
     "Subtract with Carry" :access-pattern :read)
    (sta ((#x81 2 6 indirect-x)
          ...
          (#x99 3 5 absolute-y)
          (#x9d 3 5 absolute-x))
     "Store Accumulator" :access-pattern :write)
    (stx ((#x86 2 3 zero-page)
          (#x8e 3 4 absolute)
          (#x96 2 4 zero-page-y))
     "Store X Register" :access-pattern :write)
